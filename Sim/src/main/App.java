...
public class App extends Applet implements KeyListener, ActionListener {
	...
	public void init() {
		...
		this.simulator = new SimulatorFactory().getThreadedSimulator(offscreen, width, height, 8, Runtime.getRuntime().availableProcessors());
	}
	...
	public void paint(Graphics g) {
		...
		title.setTitle(simulator.getNumParticles() + " particles " + frameInLastSecond + " fps");
